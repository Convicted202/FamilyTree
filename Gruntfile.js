module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    webpack: {
      bundler: {
        // webpack options
        entry: './<%= config.dev %>/js/app/main.js',
        output: {
          path: './<%= config.dev %>/js/',
          filename: 'bundle.js'
        },
    ...
    copy: {
      ...
      bower_components: {
        files: [
        {
          ...
          dest: '<%= config.prod %>/stylesheets/vendor/',
          flatten: true
        },
        {
          expand: true,
          cwd: '.',
          src: [
            'bower_components/gumby/fonts/icons/**'
          ],
          dest: '<%= config.prod %>/stylesheets/fonts/icons/',
          flatten: true,
          filter: 'isFile'
        }
        ]
